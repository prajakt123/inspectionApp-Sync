    ...
    return {
        ...
        _createDynamicCardsAndSetData: function(data){
          ...
          if (!kony.sdk.isNullOrUndefined(data) && Array.isArray(data) && data.length>0){
            if(!kony.sdk.isNullOrUndefined(data[0]["Response_Type"]) && typeof data[0]["Response_Type"]==='string' ){
              if(data[0]["Response_Type"].toLowerCase()!=="text" || data[0]["Response_Type"].toLowerCase()!=="listbox"){
